    ...
    <div className="container mx-auto py-1 px-4">
      <div className="flex justify-between items-center h-16">
        ...
        <div className="hidden md:flex items-center justify-center space-x-10">
          <Link href="/#features" className="text-gray-800 hover:text-gray-600 text-lg">
            Features
          </Link>
          <Link href="/#testimonials" className="text-gray-800 hover:text-gray-600 text-lg">
            Testimonials
          </Link>
          <Link href="/#pricing" className="text-gray-800 hover:text-gray-600 text-lg">
            Pricing
          </Link>
        </div>
