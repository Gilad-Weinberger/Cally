...
export async function POST(request) {
  try {
    ...
    1. "i got a 4 hour game tomorrow at 10am"
       → {"title": "Game", "startDate": "[tomorrow's date]", "endDate": "[tomorrow's date]", "startTime": "10:00", "endTime": "14:00", "color": "blue"}
    
    2. "meeting with team on friday at 2pm for 1 hour"
       → {"title": "Team Meeting", "startDate": "[next friday's date]", "endDate": "[next friday's date]", "startTime": "14:00", "endTime": "15:00"}
    
    3. "dentist appointment next tuesday at 9am"
       → {"title": "Dentist Appointment", "startDate": "[next tuesday's date]", "endDate": "[next tuesday's date]", "startTime": "09:00", "endTime": "10:00", "color": "red"}
